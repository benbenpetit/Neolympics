<template>
  ...
  <Modal v-if="modalOlympicsVisible" imgSrc="null" class="--blue --fullscreen">
    ...
    <template v-slot:buttons>
      <ButtonUI @click="modalOlympicsVisible = false" imgSrc="null" class="--white">
        <template v-slot:label>RETOUR</template>
      </ButtonUI>
      <ButtonUI @click="gotoOlympics" imgSrc="null" class="--red">
